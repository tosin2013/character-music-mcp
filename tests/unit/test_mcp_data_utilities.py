"""
Comprehensive tests for mcp_data_utilities
...
try:
    from mcp_data_utilities import *
except ImportError as e:
    pytest.skip(f"Could not import mcp_data_utilities: {e}", allow_module_level=True)


class TestMcpDataUtilities:
    """Test class for mcp_data_utilities module"""
...
class TestMcpDataUtilitiesIntegration:
    """Integration tests for mcp_data_utilities"""

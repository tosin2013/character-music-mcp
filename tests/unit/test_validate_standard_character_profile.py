"""
Comprehensive tests for validate_standard_character_profile
...
try:
    from validate_standard_character_profile import *
except ImportError as e:
    pytest.skip(f"Could not import validate_standard_character_profile: {e}", allow_module_level=True)


class TestValidateStandardCharacterProfile:
    """Test class for validate_standard_character_profile module"""
...
class TestValidateStandardCharacterProfileIntegration:
    """Integration tests for validate_standard_character_profile"""

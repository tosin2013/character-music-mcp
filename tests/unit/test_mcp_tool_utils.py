"""
Comprehensive tests for mcp_tool_utils
...
try:
    ...
    pytest.skip(f"Could not import mcp_tool_utils: {e}", allow_module_level=True)
...
class TestMcpToolUtilsIntegration:
    """Integration tests for mcp_tool_utils"""

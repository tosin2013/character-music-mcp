"""
Comprehensive tests for debug_imports
...
try:
    ...
    pytest.skip(f"Could not import debug_imports: {e}", allow_module_level=True)
...
class TestDebugImportsIntegration:
    """Integration tests for debug_imports"""

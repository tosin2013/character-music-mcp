    ...
    def _analyze_exclamation_emotions(self, exclamations: List[str]) -> List[EmotionalState]:
        ...
        if positive_count > 0:
            exclamation_emotions.append(EmotionalState(
                ...
                context=f"Positive exclamations detected",
                text_position=0,
        ...
        if negative_count > 0:
            exclamation_emotions.append(EmotionalState(
                ...
                context=f"Negative exclamations detected",
                text_position=0,
        ...
        if intense_count > 0:
            exclamation_emotions.append(EmotionalState(
                ...
                context=f"Intense emotional expressions detected",
                text_position=0,
        ...
        if total_words > 0:
            ...
            if emotional_density > 0.02:  # More than 2% emotionally weighted words
                semantic_emotions.append(EmotionalState(
                    ...
                    context=f"Text has high concentration of emotionally charged language",
                    text_position=0,

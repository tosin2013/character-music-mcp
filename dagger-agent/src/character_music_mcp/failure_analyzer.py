...
class AnalysisCache:
    ...
    def _get_cache_key(self, failure: Failure, code_context: CodeContext | None) -> str:
    ...
    def get(self, failure: Failure, code_context: CodeContext | None) -> Analysis | None:
    ...
    def set(self, failure: Failure, analysis: Analysis, code_context: CodeContext | None) -> None:
